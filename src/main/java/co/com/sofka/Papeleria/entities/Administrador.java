package co.com.sofka.Papeleria.entities;
...
public class Administrador extends Entity<AdministradorId> {
    ...
    public Administrador(AdministradorId entityId , Nombre nombre , Identificacion identificacion , Direccion direccion , Email email) {
        super(entityId);
        this.nombre = nombre;
